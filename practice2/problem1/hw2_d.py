# -*- coding: utf-8 -*-
"""
Created on Sun May 12 10:59:39 2019
...
class LossHistory(keras.callbacks.Callback): 
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        self.valid_losses.append(self.model.evaluate(self.v_data, self.v_labels)[0])
...
h.v_data =X_train[50000:]
h.v_labels =Y_train[50000:]
model.fit(X_train[50000:],  Y_train[50000:], epochs=10, validation_data=(h.v_data, h.v_labels), callbacks=[h])


# plot errors
r = plt.figure(1)
plt.plot(h.losses, 'g--', label="Train")
plt.plot(h.t_losses,'r--' ,label="Test")
plt.plot(h.valid_losses, 'b--',label="validation")
plt.legend()
r.show()
